...
from app.backend.rtmt import RTMiddleTier, Tool, ToolResult, ToolResultDirection
...
async def _report_grounding_tool(search_client: SearchClient, identifier_field: str, title_field: str,
